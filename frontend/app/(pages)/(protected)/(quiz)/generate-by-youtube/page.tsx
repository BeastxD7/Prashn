  ...
  return (
    <div className="min-h-screen w-full bg-linear-to-br from-sky-50 via-blue-50/30 to-indigo-50/20 dark:from-gray-950 dark:via-sky-950/20 dark:to-blue-950/10 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-sky-400/20 dark:bg-sky-500/5 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-blue-400/20 dark:bg-blue-500/5 rounded-full blur-3xl" />
      </div>
