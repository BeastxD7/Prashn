    ...
    >
      <div className="container mx-auto flex flex-wrap items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-2">
          <span className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-3xl bg-linear-to-b from-blue-400 to-blue-900 bg-clip-text text-transparent leading-none">
            प्रश्न |
          </span>
          <span className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-3xl bg-clip-text text-transparent bg-linear-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white tracking-tight leading-none">
            Prashn
          </span>
        </div>
      </div>
